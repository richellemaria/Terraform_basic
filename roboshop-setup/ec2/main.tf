...
#   # This will be executed on the top of the machine once it's created
  provisioner "remote-exec" {
    ...
    inline = [
      "ansible-pull -U https://github.com/richellemaria/AnsibleRepo.git -e ROOT_PASSWORD=RoboShop@1 -e ENV=dev -e COMPONENT=${var.COMPONENT} -e APP_VERSION=${var.APP_VERSION} roboshop-pull.yml"
    ]
  }
}